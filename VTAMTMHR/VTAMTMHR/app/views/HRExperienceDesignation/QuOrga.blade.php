...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Designation<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRExperienceDesignation'))
             <form name='search' action="{{url('CreateHRExperienceDesignation')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Designation</button>
			 </form>
	    @endif
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                      ...
                      <td>
					   @if($user->hasPermission('EditHRExperienceDesignation'))
						   <form id="deleteform"  action='EditHRExperienceDesignation' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRExperienceDesignation'))
							 <form id="deleteform"  action='DeleteHRExperienceDesignation' method="POST" onsubmit="return doConfirm('{{$mc->Designation}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
