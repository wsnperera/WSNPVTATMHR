...
@if(isset($Issearch))
<a href={{url('ViewHRUniversity')}}> << Back to University</a> 
@endif
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>University<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRUniversity'))
             <form name='search' action="{{url('CreateHRUniversity')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create University</button>
			 </form>
	    @endif
             ...
             <table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                       <td>{{$i++}}</td> 
					    <td>{{$mc->UniversityName}}</td>
                      <td>
					   @if($user->hasPermission('EditHRUniversity'))
						   <form id="deleteform"  action='EditHRUniversity' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRUniversity'))
							 <form id="deleteform"  action='DeleteHRUniversity' method="POST" onsubmit="return doConfirm('{{$mc->UniversityName}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
