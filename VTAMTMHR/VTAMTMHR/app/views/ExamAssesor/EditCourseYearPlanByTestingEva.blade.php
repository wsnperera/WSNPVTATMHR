    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <form class="form-horizontal" action='' method="POST">
				...
				<div class="control-group">
                    <label class="control-label" for="CourseListCode">Organisation : </label>
                        <div class="controls">
                        <input type="text" name="CourseListCode" id="CourseListCode"  value="{{CourseYearPlan::getOrganizatinName($courseYearOri->OrgId)}}" readonly />
                    </div>
                </div>
				</td>
					<td>
				 <div class="control-group">
                    <label class="control-label" for="CourseListCode">Course Name : </label>
                        <div class="controls">
					<textarea name="CourseListCode" readonly>{{$CS->CourseName}}</textarea>
				...
				<td> <div class="control-group">
                    <label class="control-label" for="CourseListCode">Year : </label>
                        <div class="controls">
						<input type="text" name="Year" value="{{$CS->Year}}" readonly/>
				...
				<td> <div class="control-group">
                    <label class="control-label" for="CourseListCode">Batch : </label>
                        <div class="controls">
						<input type="text" name="CourseListCode" value="{{$CS->batch}}" readonly/>
				...
				<td> <div class="control-group">
                    <label class="control-label" for="CourseLevel">Course Level : </label>
                        <div class="controls">
						<input type="text" name="CourseListCode" value="{{$CS->CourseLevel}}" readonly/>
				...
				<td> <div class="control-group">
                    <label class="control-label" for="CourseListCode">Medium : </label>
                        <div class="controls">
							<input type="text" name="CourseListCode" value="{{$CS->Medium}}" readonly/>
				...
				<input type="date" name="ExActualStartDate" id="ExActualStartDate" value="{{$CS->ExActualStartDate}}"/>
                ...
                <div class="controls" id="ModuleDiv">
				<input type="date" name="ExActualEndDate" id="ExActualEndDate" value="{{$CS->ExActualEndDate}}"/>
                ...
                <div class="controls" id="ModuleDiv">
				<input type="date" name="PreAssessmentDate" id="PreAssessmentDate" value="{{$CS->PreAssessmentDate}}" />
				...
				@if($CS->FinalExamHeld =='Yes')
				<option value="Yes" selected>Yes</option>
				<option value="No">No</option>	
				@elseif($CS->FinalExamHeld =='No')
			 ...
			 <div class="control-group" id="withAltField">
                    ...
                    <div class="controls">
                        ...
                        <input type="text" id="altField" name = "dates" value="" style="width:100%" readonly /></br>
						 <input type="hidden" id="AlreadySelected" name = "datesA" value="{{$string}}" style="width:100%" readonly />
                  ...
                  <label class="control-label" >Document Sending Date To HO: </label>
                    ...
                    <div class="controls">
                        ...
                        <input type="text" id="altFieldDSHO" name = "datesDSHOM" value="" style="width:100%" readonly /></br>
						 <input type="hidden" id="AlreadySelectedDSHO" name = "datesDSHO" value="{{$stringDSHO}}" style="width:100%" readonly />
                  ...
                  <label class="control-label" >Result Checked Date: </label>
                    ...
                    <div class="controls">
                        ...
                        <input type="text" id="altFieldRCD" name = "datesRCDM" value="" style="width:100%" readonly /></br>
						 <input type="hidden" id="AlreadySelectedRCD" name = "datesRCD" value="{{$stringRCD}}" style="width:100%" readonly />
			...
			<div class="control-group">
				...
				<div class="controls">
				<textarea style="width:470px; height:150px;" placeholder="Enter Comments..............." id="Comment" name="Comment">{{$CS->Comment}}</textarea>
			</div>
			</div>
