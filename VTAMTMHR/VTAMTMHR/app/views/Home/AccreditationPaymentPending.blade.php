        ...
        <div class="span12">
            <div class="span8" style="width: 100%">
                <div class="page-header position-relative">
                    <h1>
                        Accreditation Application Payment Record 
                        <small>
                            <i class="icon-double-angle-right"></i>
                            Accreditation Application Payment Pending List
                        </small>            
                    </h1>
                </div>
            </div>
            ...
            <p><b>* පහත දක්වා ඇති පාඨමාලා සඳහා  ප්‍රතීතන අයදුම්පත්  ගෙවීම්  සිදුකර එම දත්ත මෘදුකාංගයට ඇතුලත් කරන්න.</b></p>
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                <thead>
						...
						<th class='center'>Accredit Application Payment Status</th>
                  ...
                  $SerialNo=1;
                  ?>
                @if(isset($sqlaccrediationPayListCount))
                
                <form> 
				@foreach($sqlaccrediationPayListCount as $t)
                        ...
                        <tr>
                            ...
                            <td class="center"><font color="green">{{$t->ApplicationReciievedStatus}}</font></td>
							 <td class="center"><font color="green">{{$t->PaymentSubmitStatus}}</font></td>
...
function downloadReport() 
 {
        ...
        window.location.replace("DownloadAccreditationInstaPayment");
