        ...
        <div class="span12">
            <div class="span8" style="width: 100%">
                <div class="page-header position-relative">
                    <h1>
                        Accreditation Application For Upgrade
                        <small>
                            <i class="icon-double-angle-right"></i>
                            Accreditation Upgrade Application Pending List
                        </small>            
                    </h1>
                </div>
            </div>
            ...
            <p>
			<b>* පහත දක්වා ඇති පාඨමාලා සඳහා ප්‍රතීතන අයදුම් පත අන්තර්ජාලය ඔස්සේ TVEC ආයතනය වෙත ඉදිරිපත් කරන්න.අදාළ ගෙවීම් සඳහා form 1 පත්‍රිකාව පුහුණු අංශය වෙත ලැබීමට කටයුතු කරන්න.</b></p>
			...
			<table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<tr>
                        ...
                        <th class='center'>Accreditation Application Status</th>
                  ...
                  $SerialNo=1;
                  ?>
                @if(isset($ApproveACAppList))
                
                <form> 
				@foreach($ApproveACAppList as $t)
                        ...
                        <tr>
							...
							<td class="center"><font color="red">{{$t->ApplicationReciievedStatus}}</font></td>
...
function downloadReport() 
 {
        ...
        window.location.replace("DownloadAccreditationInstaTobeUpgradeApplication");
