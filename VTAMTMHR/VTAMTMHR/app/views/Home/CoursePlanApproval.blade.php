        ...
        <div class="span12">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                <thead>
                  ...
                  $SerialNo=1;
                  ?>
                @if(isset($AproveCMPList))
                @foreach($AproveCMPList as $t)
                ...
                <form> 
				  @if($t->Approved == 0)
                        <tr>
                            ...
                            <td><font color="red">{{$t->CourseName}}</font></td>
                            <td class="center"><font color="red">{{$t->Year}}</font></td>
...
bootbox.confirm("<form id='infos' action=''><div class='control-group'><div class='controls'>\
 ...
 $(".green").click(function(){
     ...
     $.ajax  ({
                    url: "{{url::to('DDADConfirmMOCenterMOnitoringPlan')}}",
                    data: { id: id},
...
function doStuffWithResults(id,reason) {
     ...
     $.ajax  ({
                    url: "{{url::to('DDADRejectMOCenterMOnitoringPlan')}}",
