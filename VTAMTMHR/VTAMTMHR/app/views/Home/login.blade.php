					...
					<div class="span12">
						...
						<div class="login-container">
							<div class="row-fluid">
								<div>
									<h2>										
										<center><img src="{{Url('assets/VTA.jpg')}}" height="100" width="130"/>
										<P class="orange2" style="font-family:Arial;font-size:100%;font-weight: bold;">Vocational Training Authority<br>Training and Human Resource Management System</P></center>
										...
										<div class="widget-body">
											<div class="widget-main">
												...
												<div class="space-6"></div>
													...
													<form name="loginform" action={{URL::action('HomeController@authuser')}} method="POST">
...
<span class="red">{{Session::get('error')}}</span>
@endif
