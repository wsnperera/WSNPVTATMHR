...
<div class="page-content">
    <div class="row-fluid">
        <div class="span12">
            ...
            <p>
			<b>* පහත දක්වා ඇති පාඨමාලා වල ප්‍රතීතනය ඉදිරි මාසය ඇතුලත දී කල්  ඉකුත් වේ .</b></p>
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<tr>
                        ...
                        <th class='center'>Accreditation Valid From</th>
						<th class='center'>Accreditation Valid To</th>
				...
				@foreach($ApproveACAppList as $t)
                        ...
                        <tr>
							...
							<td class="center"><font color="red">{{$t->AccreditDate}}</font></td>
							<td class="center"><font color="red">{{$t->AccreditationValidDate}}</font></td>
...
<script type="text/javascript">
 ...
 function downloadReport() 
 {
        ...
        window.location.replace("DownloadAccreditationWillExpire");
