...
<div class="page-content">
    <div class="row-fluid">
		...
		@if($user->hasPermission('CreateIRJOBPVacancy'))
             <form name='search' action="{{url('CreateIRJOBPVacancy')}}" method='get'>
    ...
    <tr>
        ...
        <td>
            <form name='search' action="{{url('PrintIRJobVacancy')}}" method='POST' class="form-horizontal">
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
					   ...
					   <td>{{$mc->SalaryGap}}</td>
					   <td>@if($mc->VacancyType == 'GenderBased')Gender Based Vacancies @else Common Vacancies @endif</td>
                      ...
                      <td>
					   @if($user->hasPermission('EditIRJOBPVacancy'))
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteIRJOBPVacancy'))
							@if(($OccuipFemale + $OccuipMale) == 0)
							 <form id="deleteform"  action='DeleteIRJOBPVacancy' method="POST" onsubmit="return doConfirm('{{$mc->Category}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
