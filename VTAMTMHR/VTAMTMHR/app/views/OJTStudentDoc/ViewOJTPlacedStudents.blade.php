	...
	<div class="span12">
        <div class="span8" style="width: 100%">
            <div class="page-header position-relative">
                ...
                <h1>View OJT Placed Students<small><i class="icon-double-angle-right"></i>View Documents</small></h1>
            </div>
			 </div>
            <form class="form-horizontal" action='{{url("ViewOJTStudentsDoc")}}' method="POST"  id='NewModule'>
                    ...
                    <tr>
                       ...
                       <td class="center">{{$tt++}}</td>
					    <td class="center">
                                ...
                                <form id="editform"  action='ViewOJTStudentsDocumentList' method="GET" >
