...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Training Programmes<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRTrainingProgram'))
             <form name='search' action="{{url('CreateHRTrainingProgram')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Programme</button>
			 </form>
	    @endif
             ...
             <table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                       <td>{{$i++}}</td> 
					    <td>{{$mc->NameOfTheProgram}}</td>
                      <td>
					   @if($user->hasPermission('EditHRTrainingProgram'))
						   <form id="deleteform"  action='EditHRTrainingProgram' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRTrainingProgram'))
							 <form id="deleteform"  action='DeleteHRTrainingProgram' method="POST" onsubmit="return doConfirm('{{$mc->NameOfTheProgram}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
