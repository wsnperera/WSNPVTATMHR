...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Training Institutes<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRTrainingInstitute'))
             <form name='search' action="{{url('CreateHRTrainingInstitute')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Institutes</button>
			 </form>
	    @endif
             ...
             <table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                       <td>{{$i++}}</td> 
					    <td>{{$mc->InstituteName}}</td>
                      <td>
					   @if($user->hasPermission('EditHRTrainingInstitute'))
						   <form id="deleteform"  action='EditHRTrainingInstitute' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRTrainingInstitute'))
							 <form id="deleteform"  action='DeleteHRTrainingInstitute' method="POST" onsubmit="return doConfirm('{{$mc->InstituteName}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
