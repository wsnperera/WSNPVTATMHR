...
<form class="form-horizontal" action="{{url('EditHRTrainingInstitute')}}" method="POST"/>
<input type="hidden"  name="QO_ID" value="{{Request::get('id')}}" />
 <div class="control-group">
                    <label class="control-label">Institute/University Name:</label>
                    <div class="controls">
                        <textarea id="OrgaName" name="OrgaName" required="true" >{{$quorg->InstituteName}} </textarea>
                    </div>
                </div>
				<div class="control-group">
				 <div class="controls">
