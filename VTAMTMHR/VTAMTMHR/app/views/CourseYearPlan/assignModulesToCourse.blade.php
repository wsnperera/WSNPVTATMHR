        ...
        <div class="span8">
            ...
            <form class="form-horizontal" action="" method="POST" id="courseyearplansubmit">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="CourseListCode"   value="{{$courseYearPlan->CourseListCode}}" required="true" readonly="true"/>
                    </div>
                </div>
...
/*
 ...
 ({
 type: "GET",
 url: "{{Url('CoursewiseSummarySearch')}}",
 ...
 $("#form-field-select-3").change(function()
    {
       ...
       //alert(cid);
        ...
        $.ajax
                ({
                    type: "GET",
                    url: "{{Url('getcompetencystandardnew')}}",
                    data: {corseid: cid},
                    dataType: "json",
                    success: function(result)
                    {
