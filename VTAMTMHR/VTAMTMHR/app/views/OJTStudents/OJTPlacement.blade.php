        ...
        <div class="span8">
            ...
            <form class="form-horizontal" action='' method="POST" id="myform">
				...
				<td><div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="Batch" id="Batch" value="{{$CourseYearPlan->batch}}" readonly />
				...
				<center><hr/></center>
				<h5><b><font color="red">OJT Placement Details</font></b></h5>
				<div class="control-group">
                <label class="control-label" >District:</label>
                <div class="controls">
			...
			<div class="control-group">
				...
				<div class="control-group">
				 ...
				 <div class="control-group">
                    <label class="control-label" >Allowence : </label>
                        <div class="controls" >
                            <input type="text" name="Salary" id="Salary"  value="0"/>
                           <span style="color:red">* Eg 10000.00</span>
                           
                        </div>         
                 </div>	
				 <div class="control-group">
                    <label class="control-label" >Placement Done By : </label>
                        <div class="controls" >
                            <select id="PlacementThrough" name="PlacementThrough" required="true">
                        <option value="">--- Select Option ---</option>
						 <option value="VTA">Through VTA</option>
						  <option value="NAITA">Through NAITA</option>
                    </select><span style="color:red">*</span>
               ...
               <div class="control-group">
                    <div class="controls">
                        <input type="submit" id="button" class="btn btn-block btn-success" value="Save"/>
                    </div>
                </div>
...
<script type="text/javascript">
  ...
  $("#elec_code").change(function() {
       var District = $("#DistrictCode").val();
        ...
        $.ajax({
            type: "GET",
            url: "{{url::to('GetOJTAvailableVacancy')}}",
