...
<div class="page-content">
	...
	<div class="span12">
        <div class="span8" style="width: 100%">
            <div class="page-header position-relative">
                ...
                <h1>View OJT Placed Students<small><i class="icon-double-angle-right"></i>View</small></h1>
            </div>
			 </div>
            <form class="form-horizontal" action='{{url("ViewOJTPlacedStudents")}}' method="POST"  id='NewModule'>
    ...
    <tr>
        ...
        <td>
            <form name='search' action="{{url('PrintOJTPlacedStudents')}}" method='POST' class="form-horizontal">
