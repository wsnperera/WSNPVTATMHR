...
<div class="page-content">
    <div class="row-fluid">
        <div class="span8">
            ...
            <h1>KPI Self Satisfaction Form<small><i class="icon-double-angle-right"></i>Create</small></h1>
			...
			<table id="sample-table-2" class="table table-striped table-bordered table-hover">
               ...
               @foreach($Questions as $c)
                                ...
                                <tr>
                                    ...
                                    <td class='center'>
                                        <input  style="width:50px"  type="number" max="{{$c->Fweight}}" min ="0" name="AnswerID[]" id="AnswerID[]" required="true" />
                ...
                <div class="controls">
                    <select  class="chzn-select" name="QO_ID" onload="" id="QO_ID" required>
                        <option value="">--Select Superviser--</option>
                         ...
                         <option value="{{$t->id}}">{{$t->Designation}} - {{$t->EPFNo}} - {{$t->Initials}} {{$t->LastName}}</option>
                        @endforeach
