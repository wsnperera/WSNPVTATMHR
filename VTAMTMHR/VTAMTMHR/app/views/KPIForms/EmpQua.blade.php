                ...
                @if(isset($moduleTask))
                    ...
                    <tr>
					   ...
					   @if($SACount != 0)
						   ...
						   @else
					   <a href="{{url('CreateKPIForm?id='.$mc->EmpId)}}"><button type="button" class="btn btn-success btn-mini"><i class="icon-edit icon-2x icon-only"></i></button></a>
						@endif
						@else
					   ...
					   @endif
					    ...
					    <td class='center'>
						 @if($chechcount != 0)
							 @if($chech->SubmitTotheSupervisor == 0)
							<a href="{{url('EditKPIForm?id='.$chech->id)}}"><button type="button" class="btn btn-warning btn-mini"><i class="icon-edit icon-2x icon-only"></i></button></a>
						 @endif
						 @endif
						</td>
                       <td class='center'>
						 @if($chechcount != 0)
							<a href="{{url('ViewSeltKPIForm?id='.$chech->id)}}"><button type="button" class="btn btn-pink btn-mini"><i class="icon-edit icon-2x icon-only"></i></button></a>
						 @endif
						</td>
					    <td class='center'> 
						 @if($chechcount != 0)
							 @if($chech->SubmitTotheSupervisor == 0)
						<font color="green"><a class="green"  id="{{$chech->id}}"> <i class="icon-thumbs-up bigger-250"></i></a> </font>
						@else
