...
@if(isset($Issearch))
<a href="{{url('ViewJOBPStudentHistory')}}"> << Back to OJT Student History</a> 
@endif
<div class="page-content">
    <div class="page-header position-relative">

        <h1>
            IR - Job Placed Student History
            <small>
...
<center>
						...
						<br/>
						<form class="form-search" action="ViewJOBPStudentHistory" method='GET' >
                            <center>
        ...
        if(searchVal != "")
        {
            //$("#getoldNIC").val(searchVal);
                ...
                ({
                    beforeSend: function() 
                    {
                        document.getElementById('loding').innerHTML = "<br><br><img  src=\"{{Url('assets/redballs.gif')}}\"/>";

                        $('#table').hide();
                    },

                    type: "GET",
                    url: 'IRJOBPStudentProfileajaxViewData',
...
function doStuffWithResults(id,reason) {
	...
	//alert(id);
     ...
     $.ajax  ({
                    url: "{{url::to('AddJOBPStudentDropout')}}",
                   ...
                   success: function(result) {
                       ...
                       //location.reload();  
					   bootbox.alert('JOB Placed Dropout Added Successfully!!!');
					   location.reload();
