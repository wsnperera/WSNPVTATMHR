    ...
    <div class="row-fluid">
        <div class="span8">
            <div class="page-header position-relative">
                ...
                <h1>OJT Student<small><i class="icon-double-angle-right"></i>Edit</small></h1>
            </div>
            <form class="form-horizontal" action='' method="POST">
				...
				<input type="hidden" value="{{$districtD}}" name="districtD" id="districtD"/>
                    ...
                    <div class="controls">
                      <select name="Year" id="Year" required>
                            <option @if($CourseYearPlan->Year == '') selected="true" @endif value="" required>--- Select Year ---</option>
							<option @if($CourseYearPlan->Year == $year-2) selected="true" @endif value="{{$year-2}}">{{$year-2}}</option>
							<option  @if($CourseYearPlan->Year == $year-1) selected="true" @endif value="{{$year-1}}">{{$year-1}}</option>
                            <option @if($CourseYearPlan->Year == $year) selected="true" @endif value="{{$year}}">{{$year}}</option>
                            <option @if($CourseYearPlan->Year == $year+1) selected="true" @endif value="{{$year+1}}">{{$year+1}}</option>
                            <option @if($CourseYearPlan->Year == $year+2) selected="true" @endif value="{{$year+2}}">{{$year+2}}</option>
                            <option  @if($CourseYearPlan->Year == $year+3) selected="true" @endif value="{{$year+3}}">{{$year+3}}</option>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <select name="Batch" id="Batch" required>
                            <option @if($CourseYearPlan->batch == '') selected="true" @endif value="" >--- Select Batch ---</option>
                            <option @if($CourseYearPlan->batch == '1') selected="true" @endif value="1">1</option>
                            <option @if($CourseYearPlan->batch == '2') selected="true" @endif value="2">2</option>
                            <option @if($CourseYearPlan->batch == '1.2') selected="true" @endif value="1.2">1.2</option>
							<option @if($CourseYearPlan->batch == '2.2') selected="true" @endif value="2.2">2.2</option>
                        </select>
                        <span id='img4'></span>
                    </div>
                </div>
                    ...
                    <label class="control-label" >District : </label>
                        <div class="controls" id="Trade">
                            <select name="District" id="District" required>
                                ...
                                <option @if($selectedDis == $d->DistrictCode) selected="true" @endif value="{{$d->DistrictCode}}">{{$d->DistrictName}}</option>
                                @endforeach
                            </select>
                    ...
                    <label class="control-label" >Centre : </label>
                        <div class="controls" id="Trade">
                            <select name="CenterID" id="CenterID" required>
                                ...
                                <option @if($CourseYearPlan->OrgId == $v->id) selected="true" @endif value="{{$v->id}}">{{$v->OrgaName}} - {{$v->Type}}</option>
                                @endforeach
                            </select>
                    ...
                    <label class="control-label" >Course : </label>
                        <div class="controls" id="Trade">
                            <select name="CourseYearPlanID" id="CourseYearPlanID" required>
								 ...
								 @foreach($allcourse as $lc)
                                <option @if($IRTrainee->CourseYearPlanID == $lc->id) selected="true" @endif value="{{$lc->id}}">{{$lc->Year}}-batch({{$lc->batch}}) {{$lc->CourseName}}] - {{$lc->Nvq}}-{{$lc->CourseLevel}}-{{$lc->CourseType}}-{{$lc->Duration}}</option>
                                @endforeach
                            </select>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                       <textarea name="NameWithInitials" id="NameWithInitials" required>{{$IRTrainee->NameWithInitials}} </textarea>
                    </div>
                </div>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
					<textarea name="FullName" id="FullName" required>{{$IRTrainee->FullName}}</textarea>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
					<input type="text" name="NIC" id="NIC" value="{{$IRTrainee->NIC}}" required/>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
					<input type="text" name="MISNumber" id="MISNumber" value="{{$IRTrainee->MISNumber}}" required/>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
					<input type="text" name="Mobile" id="Mobile" value="{{$IRTrainee->Mobile}}" required/>
				...
				<div class="control-group">
                    ...
                    <div class="controls">
					<textarea type="text" name="Address" id="Address" required>{{$IRTrainee->Address}}</textarea>
				...
				<div class="control-group">
					...
					<option @if($IRTrainee->Gender == '') selected="true" @endifvalue="">--- Select Gender ---</option>
					<option @if($IRTrainee->Gender == 'Male') selected="true" @endif value="Male">Male</option>
					<option @if($IRTrainee->Gender == 'Female') selected="true" @endif value="Female">Female</option>
					...
					<option @if($IRTrainee->Dropout == '') selected="true" @endifvalue="">--- Select Dropout ---</option>
					<option @if($IRTrainee->Dropout == '0') selected="true" @endif value="0">No</option>
					<option @if($IRTrainee->Dropout == '1') selected="true" @endif value="1">Yes</option>
