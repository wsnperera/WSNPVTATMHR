...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>OJT Reports<small><i class="icon-double-angle-right"></i>District Wise OJT Placement Count Report</small></h1>
        </div>
...
$('#sample-table-2').dataTable({
									...
									else 
									{
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadOJTDistrictWiseCountReport')}}",
 ...
 function downloadReport() {
									...
									{
                                        window.location.replace("DownloadOJTDistrictWiseCountReportExcel?Batch=" + Batch + "&Year=" + Year + "");
