...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>OJT Reports<small><i class="icon-double-angle-right"></i>Course Wise OJT Count Report</small></h1>
        </div>
...
$('#sample-table-2').dataTable({
									...
									else 
									{
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadOJTCourseWiseCountReport')}}",
 ...
 function downloadReport() {
									...
									{
                                        window.location.replace("DownloadOJTCourseWiseCountReportExcel?Batch=" + Batch + "&Year=" + Year + "");
