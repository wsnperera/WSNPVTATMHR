...
<!--            @if ($errors->has())
            ...
            <form class="form-horizontal" action="{{url('EditHREmployeeExperience')}}" method="POST"/>
           ...
           <div class="control-group">
                ...
                <div class="controls">
                    <select  class="chzn-select" name="QO_ID" onload="" id="QO_ID" required>
                        ...
                        <option  value="{{$qo->id}}" @if($empqua->CompanyId == $qo->id) selected="true" @endif>{{$qo->CompanyName}}</option>
                        @endforeach
	...
	<div class="control-group">
                ...
                <div class="controls" >
                    <select class="chzn-select" name="DesignationID" id="DesignationID" onload="" required="true">
                       ...
                       @foreach ($Designation as $qo)
                        <option  value="{{$qo->id}}" @if($empqua->DesignationID == $qo->id) selected="true" @endif>{{$qo->Designation}}</option>
                        @endforeach
            ...
            <div class="control-group">
                ...
                <div class="controls" >
                    <input name="DateJoined" id="DateJoined" type="date" value="{{$empqua->DateJoined}}" ><b style="color: red">*</b>
			 ...
			 <div class="control-group">
                ...
                <div class="controls" >
                    <input name="DateResigned" id="DateResigned" type="date" value="{{$empqua->DateResigned}}" ><b style="color: red">*</b>
		  ...
		  <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="Years" id="Years"  value="{{$empqua->Years}}" style="width:45px;height: 20px" ><b style="color: red"></b>
                    <span>  & No Of Month
                          <input type="text" name="Months" id="Months" value="{{$empqua->Months}}" style="width:45px;height: 20px" ><b style="color: red"></b><b style="color: red"></b></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea type="text" rows="5" name="Reason">{{$empqua->ReasonToLeave}}</textarea>
                </div>
            </div>
