...
@if(isset($Issearch))
<a href={{url('ViewHRQualificationType')}}> << Back to Qualification Type</a> 
@endif
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Qualification Type<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRQualificationType'))
             <form name='search' action="{{url('CreateHRQualificationType')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Qualification Type</button>
			 </form>
	    @endif
                 ...
                 <tbody>
                    ...
                    <tr>
                       <td>{{$i++}}</td> 
					    <td>{{$mc->Type}}</td>
                      <td>
					   @if($user->hasPermission('EditHRQualificationType'))
						   <form id="deleteform"  action='EditHRQualificationType' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRQualificationType'))
							 <form id="deleteform"  action='DeleteHRQualificationType' method="POST" onsubmit="return doConfirm('{{$mc->Type}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
