...
@if(isset($Issearch))
<a href={{url('ViewHRQualificationCategory')}}> << Back to Qualification Category</a> 
@endif
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Qualification Category<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRQualificationCategory'))
             <form name='search' action="{{url('CreateHRQualificationCategory')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Qualification Category</button>
			 </form>
	    @endif
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                       <td>{{$i++}}</td> 
					    <td>{{$mc->QCategory}}</td>
						<td>{{$mc->CategoryLevel}}</td>
                      <td>
					   @if($user->hasPermission('EditHRQualificationCategory'))
						   <form id="deleteform"  action='EditHRQualificationCategory' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRQualificationCategory'))
							 <form id="deleteform"  action='DeleteHRQualificationCategory' method="POST" onsubmit="return doConfirm('{{$mc->QCategory}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
