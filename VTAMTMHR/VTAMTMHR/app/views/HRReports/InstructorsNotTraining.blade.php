...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Report<small><i class="icon-double-angle-right"></i>District Wise Instructors (Local/Foreign Training) Report</small></h1>
        </div>
...
$('#sample-table-2').dataTable({
                                    ...
                                    //} else {
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadDistrictInstructorNotTrainingStaffReport')}}",
                                                    data: {District: District,CenterID: CenterID,TradeID:TradeID,TrainingType:TrainingType},
                                                    dataType: 'json',
                                                    success: function (result)
                                                    {
                                                        ...
                                                        if (result.Count > 0) {
															...
															bootbox.alert("Data not found For "+Year);
                                                        }
 ...
 function downloadReport() {
                                   ...
                                   // } 
									//else {
                                        window.location.replace("DownloadDistrictInstructorNotTrainingStaffReport?District=" + District + "&CenterID=" + CenterID + "&TradeID=" + TradeID + "&TrainingType=" + TrainingType +"");
