...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Report<small><i class="icon-double-angle-right"></i>District Wise Staff Report</small></h1>
        </div>
...
<!--            Search Module Course By Course List Code : <input type='text' name="key"/>   <input type='submit' value='Search'/>-->
        ...
        <div class="control-group">
			 ...
			 <div class="control-group">
				  ...
				  <div class="control-group">
                    <label class="control-label" >Age Up to Date : </label>
                        <div class="controls" id="Trade">
                            <input name="UpToDate" id="UpToDate" type="date" />
                                <b style="color: red">*</b>
...
$('#sample-table-2').dataTable({
                                    ...
                                    //} else {
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadDistrictStaffReport')}}",
                                                    data: {District: District,CenterID: CenterID,UpToDate:UpToDate},
                                                    dataType: 'json',
                                                    success: function (result)
                                                    {
 ...
 function downloadReport() {
                                   ...
                                   // } 
									//else {
                                        window.location.replace("DownloadDistrictStaffReport?District=" + District + "&CenterID=" + CenterID + "&UpToDate=" + UpToDate + "");
