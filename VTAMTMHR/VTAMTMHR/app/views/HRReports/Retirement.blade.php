...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Report<small><i class="icon-double-angle-right"></i>District Wise Staff Retirement Report</small></h1>
        </div>
...
$('#sample-table-2').dataTable({
                                    ...
                                    //} else {
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadDistrictRetirementStaffReport')}}",
                                                    data: {District: District,CenterID: CenterID,Year:Year},
                                                    dataType: 'json',
                                                    success: function (result)
                                                    {
 ...
 function downloadReport() {
                                   ...
                                   // } 
									//else {
                                        window.location.replace("DownloadDistrictRetirementStaffReport?District=" + District + "&CenterID=" + CenterID + "&Year=" + Year +"");
