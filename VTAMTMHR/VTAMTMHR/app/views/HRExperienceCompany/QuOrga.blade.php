...
@if(isset($Issearch))
<a href={{url('ViewHRExperienceCompany')}}> << Back to Experience Organisation</a> 
@endif
<div class="page-content">
    <div class="row-fluid">
		...
		@if($user->hasPermission('CreateHRExperienceCompany'))
             <form name='search' action="{{url('CreateHRExperienceCompany')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Organisation</button>
			 </form>
	    @endif
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                      ...
                      <td>
					   @if($user->hasPermission('EditHRExperienceCompany'))
						   <form id="deleteform"  action='EditHRExperienceCompany' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRExperienceCompany'))
							 <form id="deleteform"  action='DeleteHRExperienceCompany' method="POST" onsubmit="return doConfirm('{{$mc->CompanyName}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
