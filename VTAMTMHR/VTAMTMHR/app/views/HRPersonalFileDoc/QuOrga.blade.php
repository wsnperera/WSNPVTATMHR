...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Personal File Document<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateHRPersonalFileDoc'))
             <form name='search' action="{{url('CreateHRPersonalFileDoc')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-pink">
                <i class="icon-pencil bigger-100"></i>Create Personal File Document</button>
			 </form>
	    @endif
				...
				<thead>
                 ...
                 <tbody>
					...
					@endif
                      ...
                      <td>
					   @if($user->hasPermission('EditHRPersonalFileDoc'))
						   <form id="deleteform"  action='EditHRPersonalFileDoc' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHRPersonalFileDoc'))
							 <form id="deleteform"  action='DeleteHRPersonalFileDoc' method="POST" onsubmit="return doConfirm('{{$mc->DocumentName}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
