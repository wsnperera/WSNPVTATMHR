...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>JOBP Reports<small><i class="icon-double-angle-right"></i>Course Wise Job Placement Count Report</small></h1>
        </div>
...
$('#sample-table-2').dataTable({
									...
									else 
									{
                                        ...
                                        $.ajax
                                                ({
                                                    ...
                                                    type: "GET",
                                                    url: "{{Url('LoadJOBPCourseWiseCountReport')}}",
 ...
 function downloadReport() {
									...
									{
                                        window.location.replace("DownloadJOBPCourseWiseCountReportExcel?Batch=" + Batch + "&Year=" + Year + "");
