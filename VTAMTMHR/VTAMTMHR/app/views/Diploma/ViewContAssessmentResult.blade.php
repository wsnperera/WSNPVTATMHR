        ...
        <div class="span12">
            ...
            <table id='sample-table-2' class='table table-striped table-bordered table-hover' align='center'>
                ...
                <tr align='center'>
                     ...
                     <th colspan='{{$mcacount}}' class='center'>Marks</th>
                ...
                <tr>
                     ...
                     @foreach($CAnolist as $m)
                      <th class='center'>Assessment {{$HeaderNo++}}</th>
                    @endforeach
...
$('#center').change(function(){
       ...
       var msg = '--- Select Course ---';
        $("#Course").html('');
       $.ajax  ({
                    url: "{{url::to('DipGetNominatedCourses')}}",
                    data: { center: center},
                    dataType: "json", 
...
$('#Course').change(function(){
       ...
       var msg = '--- Select Module ---';
        $("#Module").html('');
       $.ajax  ({
                    url: "{{url::to('DipGetModuleCourses')}}",
                    data: {Course: Course},
                    dataType: "json", 
                    success: function(result) {
...
$('#CANo').change(function(){
        ...
        $("#table1").html('');
       $.ajax  ({
                    url: "{{url::to('GetDipGetAssessmentTraineeList')}}",
