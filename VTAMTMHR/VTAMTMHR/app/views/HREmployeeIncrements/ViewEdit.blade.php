            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                ...
                @foreach($quorga as $t)
                        ...
                        <tr>
                           <font color="red">
							...
							@endforeach
							   ...
							   <td>
					   @if($user->hasPermission('HREmployeeEditIncrementsEditMode'))
						   <form id="deleteform"  action='HREmployeeEditIncrementsEditMode' method="GET">
					   ...
					   @endif
						 ...
						 <td>
						@if($user->hasPermission('DeleteHREmployeeIncrementApprovedRecord'))
							 <form id="deleteform"  action='DeleteHREmployeeIncrementApprovedRecord' method="POST" onsubmit="return doConfirm('Record',this)">
                                <input type="hidden" name='id' value="{{$t->id}}" />
						          ...
						          $.ajax
										({
											beforeSend: function()
											{
												...
												document.getElementById('img5').innerHTML = "<img src=\"{{Url('assets/images/abc.gif')}}\"/>";
											},
											type: "POST",
