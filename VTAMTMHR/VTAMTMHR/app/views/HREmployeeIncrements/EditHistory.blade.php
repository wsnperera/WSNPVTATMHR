...
<a href="{{url('ViewIncrementHistory')}}"> << Back to Employee Increments History</a>
	 ...
	 <div class="control-group">
                ...
                <div class="controls">
				  ...
				  <option value="">--- Select Category Year---</option>
                        ...
                        <option @if($scy->Year == $GetSerYear) selected   @endif value="{{$scy->Year}}">{{$scy->Year}}</option>
                        @endforeach
                    </select>
                    <b style="color: red">*</b>
                </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select   name="QO_ID" id="QO_ID" required>
                        ...
                        <option  value="{{$qo->id}}" @if($empqua->ServiceCategoryID == $qo->id) selected="true" @endif>{{$qo->ServiceCategory}} - {{$qo->SalaryCode}}({{$qo->SalaryScale}})</option>
                        @endforeach
                ...
                <div class="controls">
					...
					<select name="PGrade" id='PGrade' >
					 <option value="">---Select Grade---</option>
                       @foreach($GList as $gl)
				  <option @if($gl->id == $GetGradeID) selected   @endif value="{{$gl->id}}">{{$gl->Grade}}</option>
                        @endforeach 
                    </select>
                    <b style="color: red"></b>
                </div>
			 ...
			 <div class="control-group">
                ...
                <div class="controls">
                    <select  name="SalaryStepTransID"  id="SalaryStepTransID" required>
						...
						@if($st->EBAvailable == 1)
                        <option  value="{{$st->id}}" @if($empqua->SalaryStepTransID == $st->id) selected="true" @endif>{{$st->StepNo}} - {{$st->StepAmount}} (EB Available)
						</option>
						@else
							<option  value="{{$st->id}}" @if($empqua->SalaryStepTransID == $st->id) selected="true" @endif>{{$st->StepNo}} - {{$st->StepAmount}}
						</option>
							@endif
                        @endforeach
                    </select> <b style="color: red">*</b>
            ...
            <div class="control-group">
                        ...
                        <div class="controls">
							...
							<input  type="Date" name="NextIncrementDate" id="NextIncrementDate" value="{{$empqua->NextIncrementDate}}" required/><b style="color: red">*</b>
                        </div>
                    </div>
