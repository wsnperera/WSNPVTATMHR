...
<a href="{{url('HREmployeeIncrementsEditMode')}}"> << Back to Employee Increments(Edit Mode)</a>
            ...
            <div class="control-group">
					 ...
					 <div class="control-group">
                        ...
                        <div class="controls">
							...
							@foreach($action as $a)
							<option @if($empqua->Approved == $a->id) selected="true" @endif value="{{$a->id}}">{{$a->Action}}</option>
							@endforeach
					...
					<?php
						$jan = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,1);
						$feb = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,2);
						$mar = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,3);
						$apr = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,4);
						$may = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,5);
						$jun = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,6);
						$jul = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,7);
						$aug = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,8);
						$sep = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,9);
						$oct = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,10);
						$nov = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,11);
						$dec = HREmployeeIncrementHoldMonths::checkmonth($empqua->id,12);
                ...
                <div class="controls">
                    <select name="IncrementMonth[]"  id='IncrementMonth' multiple="multiple" class="chzn-select" data-placeholder="Choose Months..."  >
                        ...
                        <option  @if($jan != 0) selected="true" @endif value="1">January</option>
                        <option  @if($feb != 0) selected="true" @endif value="2">February</option>
                        <option  @if($mar != 0) selected="true" @endif value="3">March</option>
                        <option  @if($apr != 0) selected="true" @endif value="4">April</option>
                        <option  @if($may != 0) selected="true" @endif value="5">May</option>
                        <option  @if($jun != 0) selected="true" @endif value="6">June</option>
                        <option  @if($jul != 0) selected="true" @endif value="7">July</option>
                        <option  @if($aug != 0) selected="true" @endif value="8">August</option>
                        <option  @if($sep != 0) selected="true" @endif value="9">September</option>
                        <option  @if($oct != 0) selected="true" @endif value="10">October</option>
                        <option  @if($nov != 0) selected="true" @endif value="11">November</option>
                        <option  @if($dec != 0) selected="true" @endif value="12">December</option>
                    </select>
				...
				<div class="control-group"  id="ReasonDiv">
					<label class="control-label" for="form-field-12">Reason For Not Approved/Hold:</label>
						<div class="controls">
							<textarea name="Reason" id="Reason">{{$empqua->ReasonForHold}}</textarea>
						</div>
                 </div>
           <div class="control-group"  id="GrossSalaryDiv">
					<label class="control-label" for="form-field-12">Gross Salary:</label>
						<div class="controls">
							<input type="text" name="GrossSalary" id="GrossSalary" value="{{$empqua->GrossSalary}}" required/><b style="color: red">*</b>
						</div>
                 </div>
							...
							$("#QO_ID").change(function() 
	{
	 ...
	 $('#Approve').change(function() {
				   ...
				   else
				   {
					   ...
					   document.getElementById("IncrementMonth").required = false;
					   $("#GrossSalaryDiv").show();
					   document.getElementById("GrossSalary").required = true;
				   }
               }); 
</script>