...
<div class="page-content">
    <div class="row-fluid">
        <div class="page-header position-relative">
            <h1>Working Hours<small><i class="icon-double-angle-right"></i>View</small></h1>
        </div>
		@if($user->hasPermission('CreateOfficeTimes'))
             <form name='search' action="{{url('CreateOfficeTimes')}}" method='get'>
				<button type="submit" id="submit" class="btn btn-primary">
                <i class="icon-pencil bigger-100"></i>Create Working Hours</button>
			 </form>
	    @endif
		<hr/>
        <div class="span12">
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
                       ...
                       <td>
					   @if($user->hasPermission('EditOfficeTimes'))
						   <form id="deleteform"  action='EditOfficeTimes' method="GET">
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteOfficeTimes'))
							 <form id="deleteform"  action='DeleteOfficeTimes' method="POST" onsubmit="return doConfirm('{{$mc->ArrivalTime}}-{{$mc->Departute}}',this)">
                                <input type="hidden" name='id' value="{{$mc->id}}" />
