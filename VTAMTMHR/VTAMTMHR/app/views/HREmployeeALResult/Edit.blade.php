...
<!--            @if ($errors->has())
            ...
            <form class="form-horizontal" action="{{url('EditHREmployeeALResults')}}" method="POST"/>
        ...
        <div class="control-group">
			...
			<div class="control-group">
                ...
                <div class="controls">
					...
					<option value="{{$m->id}}" @if($quorg->StreamId == $m->id) selected="true" @endif>{{$m->Stream}}</option>
					@endforeach
					</select><b style="color: red">*</b>
                </div>
            </div>
             <div class="controls">
			   ...
			   <table id="sample-table-2" class="table table-striped table-bordered table-hover">
				...
				<td class="center">
							...
							<input type="text" name="GKMarks" id="GKMarks" value="{{$quorg->GeneralKowledgeMark}}" style="width: 90px"/>
