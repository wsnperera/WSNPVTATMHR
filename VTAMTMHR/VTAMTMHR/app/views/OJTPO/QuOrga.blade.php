...
@if(isset($Issearch))
<a href={{url('ViewAssignPODSDivitions')}}> << Back to Company</a> 
@endif
<div class="page-content">
    <div class="row-fluid">
		...
		@if($user->hasPermission('CreateAssignPODSDivitions'))
             <form name='search' action="{{url('CreateAssignPODSDivitions')}}" method='get'>
				...
				<thead>
                 ...
                 <tbody>
                    ...
                    <tr>
					   ...
					   ?>
					   @foreach($AddedDs as $a)
							<span>{{$a->ElectorateName}}</span><br/>
					   @endforeach
					   </td>
					   
					    
                      <td>
					   @if($user->hasPermission('EditAssignPODSDivitions'))
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteAssignPODSDivitions'))
							 <form id="deleteform"  action='DeleteAssignPODSDivitions' method="POST" onsubmit="return doConfirm('{{$mc->Designation}}',this)">
