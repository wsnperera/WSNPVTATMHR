...
@if(isset($Issearch))
<a href="{{url('ViewHREmployeeQualification')}}"> << Back to HR - Employee Qualification  </a> 
@endif
<div class="page-content">
    ...
    <div class="row-fluid">
       @if($user->hasPermission('CreateHREmployeeQualification'))
             <form name='search' action="{{url('CreateHREmployeeQualification')}}" method='get'>
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2"> @if($user->hasPermission('EditHREmployeeQualification')) Edit @endif</th>
                        <th rowspan="2">@if($user->hasPermission('DeleteHREmployeeQualification')) Remove  @endif </th>
                    </tr>
                    <tr>
						<th>Status</th>
                        <th>Year</th>
...
//                                    
                       ...
                       <td>
					   @if($user->hasPermission('EditHREmployeeQualification'))
					   ...
					   @endif
                        ...
                        <td>
						@if($user->hasPermission('DeleteHREmployeeQualification'))
							 <form id="deleteform"  action='DeleteHREmployeeQualification' method="POST" onsubmit="return doConfirm('{{$eq->Qualification}} - {{$eq->NIC}}',this)">
                                <input type="hidden" name='id' value="{{$eq->id}}" />
