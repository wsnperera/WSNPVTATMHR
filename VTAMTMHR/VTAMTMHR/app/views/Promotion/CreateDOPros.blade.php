...
<div class="page-content">
    <div class="row-fluid"> 
        <div class="span8">
            ...
            <form class="form-horizontal" action="{{url('createPromotion')}}" method="POST" name="form1"  >
                ...
                <div class="control-group">
                    ...
                    <div class="controls" id = 'EPFTransferType'>
                ...
                <div class="control-group">
                    <div class="controls" id="CheckBtn" >
...
<script type="text/javascript">
    ...
    $("#EPF").change(function () {
        ...
        $.ajax({
            ...
            success: function (re) {
                ...
                if (a[2] === "error") {
                    var alert_html = '<h4>You don\'t have permission to enter promotions...!</h4>';
                    bootbox.alert(alert_html);
                    $("#CheckBtn").hide();
                    $("#EPFTransferType").hide();
                    ...
                    document.getElementById("IncrementDay").value = '';
                    document.getElementById("Grade").value = '';
                    document.getElementById("SalaryStep").value = '';
                    document.getElementById("StartDate").value = '';
                } else {
                    if ($("#CheckBtn").is(':hidden') || $("#EPFTransferType").is(':hidden')) {
                        $("#CheckBtn").show();
                        $("#EPFTransferType").show();
                    } 
    ...
    $("#TransferType").change(function () {
        ...
        $.ajax({
            url: "{{url::to('CheckTransferTypeName')}}",
...
//                        }
                ...
                var y = "<select name=\"EmpType\" id=\"EmpType\">\n" +
                        ...
                        " <option value=\"{{$et->EmployeeType}}\">{{$et->EmployeeType}}</option>\n" +
                        " @endforeach\n" +
                        "</select>\n" +
                        "<b style=\"color: red\">*</b>";
                ...
                var to = "<select name=\"ToOrganisation\" id=\"ToOrganisation\">\n" +
                        ...
                        "<option value=\"{{$o->id}}\">{{$o->OrgaName}}</option>\n" +
                        "@endforeach\n" +
                        "</select>\n" +
                        "<b style=\"color: red\">*</b>";
...
//                } else if (tt === "4") {
                            ...
                            if (designation.match(/^Instructor.*$/)) {
                                var newPost = post;
                                var transferType = $("#TransferType").val();
                                // var empEPF = $("#EPF").val();
                                $.ajax({
                                    url: "{{url::to('PromotionNewPostCheck')}}",
                                    data: {NewPost: newPost, TransferType: transferType},
                                    success: function (re) {
...
//                } else {
                            ...
                            $('#NewPost').change(function () {
                                ...
                                $.ajax({
                                    ...
                                    beforeSend: function () {
                                        document.getElementById('ajax_img_SalaryScale').innerHTML = "<img src=\"{{Url('assets/images/abc.gif')}}\"/>";
                                    },
                                    success: function (re) {
                                        var a = re.split('/n/');
